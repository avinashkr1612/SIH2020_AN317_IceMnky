...
class GetMyLocationHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        # speak_output = (
        #     "You are the center of the world. You can do it, it does not "
        #     "matter if you are here or there, all that matters is that you "
        #     "are where you are feel like yourself. Be calm and live on. Shashank "
        #     "loves you."
        # )

        # response = response_builder.speak(speak_output)
        # response = response.set_card(SimpleCard('My Location', speak_output))
        
        return response_builder.speak("Shashank is ready to meet you, where are you?").set_card(
